...
def add_student(students):
    ...
    try:
        ...
        print("Error: Please enter valid numbers for the quantity and scores.")
...
def display_students(students):
    ...
    for student in students:
        # Format the scores list as a comma-separated string (removing .0 for whole numbers)
        scores_str = ", ".join([f"{int(s) if s.is_integer() else s}" for s in student["scores"]])
        ...
        print(f"{student['name']:<20} {student['id']:<15} {scores_str:<20} {avg_str:<10}")
    print("----------------------------------------------------------------------")
